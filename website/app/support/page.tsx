...
const faqs = [
  ...
  },
  {
    ...
    a: `Please open a GitHub Issue at github.com/Chakszzz/opencode-android/issues with: your device model, Android/iOS version, app version (Settings → About), and a description of what happened. If you opted in to crash reporting, we may already have the stack trace — your issue report helps us match it to the right bug.`,
  },
]
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-16">
        ...
        <a
          href="https://github.com/Chakszzz/opencode-android/issues"
          target="_blank"
      ...
      <div className="mt-12 p-5 rounded-xl text-sm" style={{ background: 'rgba(59,130,246,0.08)', border: '1px solid rgba(59,130,246,0.25)', color: 'var(--muted)' }}>
        Still stuck? Open a{' '}
        <a href="https://github.com/Chakszzz/opencode-android/issues/new" target="_blank"
