...
const quickLinks = [
  {
    ...
    href: 'https://github.com/Chakszzz/opencode-android#readme',
    external: true,
  },
  {
    title: 'Releases',
  ...
  },
  {
    ...
    href: 'https://github.com/Chakszzz/opencode-android/issues/new',
    external: true,
  },
  {
    title: 'Contributing',
    description: 'Want to contribute? See CONTRIBUTING.md in the repo.',
    href: 'https://github.com/Chakszzz/opencode-android/blob/main/CONTRIBUTING.md',
    external: true,
  },
]
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="rounded-xl p-6 text-center" style={{ background: 'rgba(59,130,246,0.08)', border: '1px solid rgba(59,130,246,0.25)' }}>
        ...
        <a
          href="https://github.com/Chakszzz/opencode-android/discussions"
          target="_blank"
