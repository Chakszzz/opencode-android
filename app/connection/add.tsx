    ...
    return (
      ...
      >
        ...
        <View style={[styles.helpBox, isDark && styles.helpBoxDark]}>
          ...
          <Text style={[styles.helpLabel, isDark && styles.textDark]}>{t("connection.add.quick.helpRunningPrefix")}</Text>
          <View style={[styles.codeBadge, isDark && styles.codeBadgeDark]}>
            <Text style={[styles.codeText, isDark && styles.codeTextDark]}>opencode serve --hostname 0.0.0.0</Text>
          </View>

          <Text style={[styles.helpLabel, isDark && styles.textDark, { marginTop: 12 }]}>{t("connection.add.quick.helpMacPrefix")}</Text>
          <View style={[styles.codeBadge, isDark && styles.codeBadgeDark]}>
            <Text style={[styles.codeText, isDark && styles.codeTextDark]}>ipconfig getifaddr en0</Text>
          </View>

          <Text style={[styles.helpLabel, isDark && styles.textDark, { marginTop: 12 }]}>{t("connection.add.quick.helpTailscalePrefix")}</Text>
          <View style={[styles.codeBadge, isDark && styles.codeBadgeDark]}>
            <Text style={[styles.codeText, isDark && styles.codeTextDark]}>http://100.64.12.34:4096</Text>
            <Text style={[styles.codeText, isDark && styles.codeTextDark, { marginTop: 4 }]}>http://my-mac.tailnet.ts.net:4096</Text>
          </View>

          <Text style={[styles.helpText, isDark && styles.hintDark, { marginTop: 12 }]}>
            {t("connection.add.quick.helpProtocolPrefix")}
            <Text style={[styles.inlineCode, isDark && styles.inlineCodeDark]}>http://</Text>
            {t("connection.add.quick.helpProtocolMiddle")}
            <Text style={[styles.inlineCode, isDark && styles.inlineCodeDark]}>https://</Text>
